...
image_size = (80, 80)
channels = 1
character_path = r"C:\Important files Nannaphat\coding\Project\student_chk\DATA"
...
# save model
model_save_path = r'C:\Important files Nannaphat\coding\Project\student_chk\model\detect_people_model1.h5'
